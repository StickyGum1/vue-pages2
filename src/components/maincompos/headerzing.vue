<template>
  <div class="zing-header" :class="{ 'active-bg' : isScrollingMainpage }">
      <div class="wrapper-zing-header">
          <div class="zing-header-left">
              <div class="wrapper-group-button">
                  <button class="btn back" @click="goback">
                      <i class="icon ic-back" @click="goback"></i>
                  </button>
                  <button class="btn forward" @click="goforward">
                      <i class="icon ic-forward"></i>
                  </button>
              </div>
              <div class="wrapper-searching-bar">
                  <button class="btn searching-label">
                      <i class="icon ic-search"></i>
                  </button>
                  <div class="input-searching-bar">
                      <input type="text" placeholder="Nhập tên bài hát, nghệ sĩ hoặc MV..." class="searching-bar">
                  </div>
              </div>
          </div>
          <div 
            ...
            class="zing-header-right">
              <div class="wrapper-btn-group header-tools">
                  ...
                  <button class="btn-round upload-button">
                      <i class="icon ic-upload"></i>
                  </button>
                  <button class="btn-round setting-button">
...
export default {
    ...
    mounted() {
        // console.log(window.history.length);
        // console.log(this.$root.historyCount);
    }
}
</script>
